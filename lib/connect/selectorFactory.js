        ...
        for (var _iterator = Object.keys(changes), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            if (changes[type].length > 0) {
                ...
                if (watchUnsafeWrites) {
                    dispatch({ type: _store.ActionTypes.UNSAFE_WRITE });
                }
                return;
            }
        }
...
function finalPropsSelectorFactory(dispatch, _ref3) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        (0, _verifySubselectors2.default)(mapPropsToQueries, mapQueriesToProps, mapDispatchToProps, mergeProps, options.displayName);
    }
