import { verifyPlainObject, verifyArray } from '../utils/verify';
...
export function wrapMapToPropsFunc(mapToProps, methodName) {
    return function initProxySelector(dispatch, { displayName }) {
        const proxy = function mapToPropsProxy(realmOrDispatch, ownProps) {
        ...
        proxy.mapToProps = function detectFactoryAndVerify(realmOrDispatch, ownProps) {
            ...
            let props = proxy(realmOrDispatch, ownProps);
